...
//		{
//			if(l.getTitolo().equals(libro.getTitolo()) && l.getAutori().equals(libro.getAutori()) && l.getAnnoDiUscita()==libro.getAnnoDiUscita()
...
//	}
	...
	public Vector<Risorsa> filtraLibriPerAutori(String autore) 
	{
		...
		for(Risorsa l : getRisorse())
		{
//			metodo getAutori è solo di Libro
			Libro libro = (Libro)l;
