			...
			case 1://FILTRA RICERCA
			{
				...
				switch(scegli)
				{
					...
					case 1: //FILTRA PER TITOLO
					{
						...
						FilmsFiltrati = MenuFiltroFilm.filtraFilmPerTitolo(titoloParziale, films);
						break;
					}
					case 2://FILTRA PER ANNO PUBBLICAZIONE
					{
						annoUscita = InputDati.leggiIntero("Inserisci l'anno di uscita: \n", Film.getAnnoPrimaPellicola(), GestioneDate.ANNO_CORRENTE);
						FilmsFiltrati = MenuFiltroFilm.filtraFilmPerUscita(annoUscita, films);
						break;
					}
					case 3: //FILTRA PER AUTORE
					{
						nomeRegista = InputDati.leggiStringaNonVuota("Inserisci il nome del regista:  \n");
						FilmsFiltrati = MenuFiltroFilm.filtraFilmPerRegista(nomeRegista, films);
						break;
					}
				}
